...
public class RenderClient {
	...
	public class PlayModemSound implements Runnable {
		...
		public void run() {
				...
				try {
					BufferedInputStream myStream  = new BufferedInputStream(ClassLoader.getSystemResourceAsStream("loopsound.wav"));
					AudioInputStream stream;
					AudioFormat format;
					DataLine.Info info;
					Clip clip;

					stream = AudioSystem.getAudioInputStream(myStream);
